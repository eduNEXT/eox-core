...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_CourseSettings_css__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_CourseSettings_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__css_CourseSettings_css__);
...
var CourseSettings = function (_React$Component) {
  ...
  _createClass(CourseSettings, [{
    ...
    value: function handleFindCoursesSubmit() {
      var _this2 = this;
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__client__["a" /* clientRequest */])(queryUrl, 'GET').then(function (res) {
        ...
        if (response.status !== 'Failed') _this2.fillCourseList(response);else _this2.failedCourseRegexMatch(response);
    ...
    value: function fillCourseList(response) {
      var courseList = response.courses.map(function (courseKey) {
    ...
    key: 'failedCourseRegexMatch',
    value: function failedCourseRegexMatch(response) {
      this.setState({
        openAlert: true,
    ...
    value: function submitNewDetailSetting() {
      ...
      var queryUrl = '' + this.detailSettingsUrl + courses[this.courseIndexGet];
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__client__["a" /* clientRequest */])(queryUrl, 'GET').then(function (res) {
        if (res.ok) return res.json();else _this5.handleResponseError(res);
      }).then(function (response) {
        // Deep clone response
        var responseData = JSON.parse(JSON.stringify(response));
        _this5.postNewDeatilSetting(responseData, queryUrl);
      }).catch(function (error) {
        console.log(error);
      });
    }
    ...
    value: function postNewDeatilSetting(response, url) {
      var _this6 = this;
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'label',
              null,
              'Current operation will apply to the following courses:'
            ),
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              'div',
              { className: __WEBPACK_IMPORTED_MODULE_3__css_CourseSettings_css___default.a.coursesList },
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'ul',
                null,
                this.state.courseListHtml
              )
            )
          )
        ),
...
// module
exports.push([module.i, "/* Styles for CourseSettings React js component */\n\n._1wpoJpXnmFiyVQV0sUokvH {\n    position: relative;\n    width: 100%;\n    height: 200px;\n    max-height: 200px;\n    overflow: auto;\n    border: solid 1px black;\n    padding: 5px;\n}\n", ""]);

// exports
exports.locals = {
	"coursesList": "_1wpoJpXnmFiyVQV0sUokvH"
};
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!./CourseSettings.css", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!./CourseSettings.css");
